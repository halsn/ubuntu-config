...
config_node() {
  ...
  source $HOME/.bashrc
  nvm install stable
  npm i -g eslint_d eslint-plugin-import eslint-plugin-node eslint-plugin-promise eslint-plugin-standard eslint-plugin-jest eslint-plugin-react
  echo "---------------finished----------------"
}
...
config_yarn() {
  ...
  yarn global add http-server nodemon js-beautify htmlhint jsonlint csslint eslint
  echo "---------------finished----------------"
}
